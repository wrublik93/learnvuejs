  ...
  <div class="mainDiv">
    ...
    <div class="content">
      <form action="#" class="authorization">
        <div class="md-2">
          <div style="width: 32px; margin: 0 0 -47px 0;">
          <!--<div style="position: relative; bottom: -50px; width: 35px">-->
    ...
    <footer class="footer">Task Manager<br>Copyright &copy; 2019</footer>
  </div>
</template>
<script>
export default {
